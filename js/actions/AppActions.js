...
import {SET_AUTH, CHANGE_FORM, SENDING_REQUEST, SET_ERROR_MESSAGE, CHANGE_SEARCH} from '../constants/AppConstants';
...
export function SearchTextChanged(data) {
    return (dispatch) => {
        dispatch(sendingRequest(true));
        axios({
            method: 'get',
            url: 'https://swapi.co/api/planets/?search='+data,
            responseType: 'stream'
        })
            .then(function (response) {
                console.log(response.data);
                dispatch(sendingRequest(false));
                dispatch(changeSearchText(response.data.results));
            });
    }
}
...
export function changeSearchText(newState) {
    return {type: CHANGE_SEARCH, newState};
}
